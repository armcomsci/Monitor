                ...
                <div class="page-header">
                    <nav class="breadcrumb-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><span>เส้นทางต่างจังหวัด</span></li>
                        </ol>
                    </nav>
                </div>
            </li>
                        ...
                        <div class="mail-box-container">
                            <div id="mailbox-inbox" class="accordion mailbox-inbox p-3">
                                <ul class="nav nav-tabs mb-3 mt-3" id="borderTop" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="border-top-home-tab" data-toggle="tab" href="#main" role="tab" aria-controls="border-top-home" aria-selected="true">ข้อมูลภาค</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="RegProven-tap" data-toggle="tab" href="#RegProven" role="tab" aria-controls="border-top-profile" aria-selected="false">ข้อมูลจังหวัด</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="RegAump-tap" data-toggle="tab" href="#RegAump" role="tab" aria-controls="border-top-contact" aria-selected="false">ข้อมูลเขต/อำเภอ</a>
                                    </li>
                                   
                                </ul>
                                <div class="tab-content" id="borderTopContent">
                                    <div class="tab-pane fade show active" id="main" role="tabpanel" aria-labelledby="border-top-home-tab">
                                        <h3 class="mb-4 pt-2">ข้อมูลภาค</h3>
                                    ...
                                    <div class="tab-pane fade" id="RegProven" role="tabpanel" aria-labelledby="border-top-profile-tab">
                                        <h3 class="mb-4 pt-2">ข้อมูลจังหวัด</h3>
                                        <div class="table-responsive" style="height: 650px;" id="Prothai_tm">
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="RegAump" role="tabpanel" aria-labelledby="border-top-contact-tab">
                                        <h3 class="mb-4 pt-2">ข้อมูลเขต/อำเภอ</h3>
                                        <div class="table-responsive" style="height: 650px;" id="Ampthai_tm">
                                        </div>
                                    </div>
...
<script>
    $('#RegProven-tap').click(function (e) { 
        e.preventDefault();
        $.ajax({
            type: "get",
            url: url+"/GetProvince",
            ...
            success: function (response) {
                $('#Prothai_tm').empty();
                $('#Prothai_tm').html(response);
            }
        });
    });

    $('#RegAump-tap').click(function (e) { 
        e.preventDefault();
        $.ajax({
            type: "get",
            url: url+"/GetAmpthaiTm",
            // data: "data",
            // dataType: "dataType",
            success: function (response) {
                $('#Ampthai_tm').empty();
                $('#Ampthai_tm').html(response);
            }
        });
    });
</script>
