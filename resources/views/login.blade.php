...
<style>
    body{
        ...
        background-image: url("{{ asset('/image/Strava.gif') }}");
        height: 100%;
...
<body class="form">
            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <p class="">เข้าสู่ระบบด้วยรหัสพนักงาน</p>
                        
                        <form class="text-left" id="FormLogin" action="{{ url('/Checklogin') }}" method="post">
                            @csrf
                            <div class="form">
                                <div id="username-field" class="field-wrapper input">
                                    <label for="username">รหัสพนักงาน</label>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                                    <input id="username" name="username" type="text" class="form-control" placeholder="x-xxx-xxxx">
                                </div>
                                ...
                                <div class="d-sm-flex justify-content-between">
                                    <div class="field-wrapper">
                                        <button type="submit" class="btn btn-primary" value="">เข้าสู่ระบบ</button>
                                    </div>
                                </div>
    ...
    <script src="{{ asset('theme/assets/js/authentication/form-2.js') }}"></script>
